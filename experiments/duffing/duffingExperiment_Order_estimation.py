...
from misc.telegrambot import telegram_chatbot
...
params['model_path'] = 'model/duffing/uncorrected/addedStates_full/'
...
path_to_data = 'data/duffing/uncorrected/duffingOscillator_uncorrected'
...
params['alpha_lin_state_prediction_loss'] = 3.0
...
looper_params = [
                 # ['model/duffing/uncorrected/addedStates_full/S3_n_2/', 1, 2, [w_state, 20, 40, 60, 3],
                 #  [2, 20, 40, 60, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 # ['model/duffing/uncorrected/addedStates_full/S4_n_2/', 1, 2, [w_state, 20, 40, 60, 2],
                 #  [2, 20, 40, 60, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 # ['model/duffing/uncorrected/addedStates_full/S1_n_2/', 2, 2, [w_state, 20, 40, 60, 2 - 3],
                 #  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 # ['model/duffing/uncorrected/addedStates_full/S2_n_2/', 2, 2, [w_state, 20, 40, 60, 2 - 3],
                 #  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_3/', 1, 3, [w_state, 20, 40, 60, 3],
                  [3, 20, 40, 60, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_3/', 1, 3, [w_state, 20, 40, 60, 3],
                  [3, 20, 40, 60, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 # ['model/duffing/uncorrected/addedStates_full/S1_n_3/', 2, 3, [w_state, 20, 40, 60, 3 - 3],
                 #  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 # ['model/duffing/uncorrected/addedStates_full/S2_n_3/', 2, 3, [w_state, 20, 40, 60, 3 - 3],
                 #  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_4/', 1, 4, [w_state, 20, 40, 60, 4],
                  [4, 20, 40, 60, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_4/', 1, 4, [w_state, 20, 40, 60, 4],
                  [4, 20, 40, 60, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S1_n_4/', 2, 4, [w_state, 20, 40, 60, 4 - 3],
                  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S2_n_4/', 2, 4, [w_state, 20, 40, 60, 4 - 3],
                  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_5/', 1, 5, [w_state, 20, 40, 60, 5],
                  [5, 20, 40, 60, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_5/', 1, 5, [w_state, 20, 40, 60, 5],
                  [5, 20, 40, 60, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S1_n_5/', 2, 5, [w_state, 20, 40, 60, 5 - 3],
                  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S2_n_5/', 2, 5, [w_state, 20, 40, 60, 5 - 3],
                  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_6/', 1, 6, [w_state, 20, 40, 80, 6],
                  [6, 20, 40, 80, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_6/', 1, 6, [w_state, 20, 40, 80, 6],
                  [6, 20, 40, 80, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S1_n_6/', 2, 6, [w_state, 20, 40, 80, 6 - 3],
                  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S2_n_6/', 2, 6, [w_state, 20, 40, 80, 6 - 3],
                  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_7/', 1, 7, [w_state, 20, 40, 80, 7],
                  [7, 20, 40, 80, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_7/', 1, 7,
                  [w_state, 20, 40, 80, 7], [7, 20, 40, 80, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S1_n_7/', 2, 7, [w_state, 20, 40, 80, 7 - 3],
                  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S2_n_7/', 2, 7, [w_state, 20, 40, 80, 7 - 3],
                  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_8/', 1, 8, [w_state, 20, 40, 80, 8],
                  [8, 20, 40, 80, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_8/', 1, 8, [w_state, 20, 40, 80, 8],
                  [8, 20, 40, 80, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S1_n_8/', 2, 8, [w_state, 20, 40, 80, 8 - 3],
                  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S2_n_8/', 2, 8, [w_state, 20, 40, 80, 8 - 3],
                  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_9/', 1, 9, [w_state, 20, 40, 100, 9],
                  [9, 20, 40, 100, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_9/', 1, 9, [w_state, 20, 40, 100, 9],
                  [9, 20, 40, 100, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S1_n_9/', 2, 9, [w_state, 20, 40, 100, 9 - 3],
                  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S2_n_9/', 2, 9, [w_state, 20, 40, 100, 9 - 3],
                  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_10/', 1, 10, [w_state, 20, 40, 100, 10],
                  [10, 20, 40, 100, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_10/', 1, 10, [w_state, 20, 40, 100, 10],
                  [10, 20, 40, 100, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S1_n_10/', 2, 10, [w_state, 20, 40, 100, 10 - 3],
                  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S2_n_10/', 2, 10, [w_state, 20, 40, 100, 10 - 3],
                  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S3_n_20/', 1, 20, [w_state, 20, 60, 120, 20],
                  [20, 20, 60, 120, 3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/duffing/uncorrected/addedStates_full/S4_n_20/', 1, 20, [w_state, 20, 60, 120, 20],
                  [20, 20, 60, 120, 3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['model/duffing/uncorrected/addedStates_full/S1_n_20/', 2, 20, [w_state, 20, 60, 120, 20 - 3],
                  [2], [params['dim_system_input']], [params['dim_system_input']]],
                 ['model/vanDerPol/own_dataGet/S2_n_20/', 2, 20, [w_state, 20, 60, 120, 20 - 3],
                  [2], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]]
                 ]
...
for element in looper_params:
    bot.send_message('Run ' + str(i) + ' of ' + str(len(looper_params)) + ' started!')
    ...
    bot.send_message('Run ' + str(i) + ' of ' + str(len(looper_params)) + ' Finished!')
    i += 1

bot.send_message('Optimization finished!')
